  ...
  return (
    <SectionLayout>
        <div className='relative max-w-xl mx-auto'>
            ...
            <div className='absolute bottom-8 left-1/2 -translate-x-1/2 bg-black border border-white flex items-center gap-4 p-2 rounded-md rounded-xl py-2 px-4 w-[60%] gap-4'>
                <img 
